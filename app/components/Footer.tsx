...
export default function Footer({ locale = "uz" }: FooterProps) {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-1">
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                Самый удобный и надёжный способ купить Telegram Premium в Узбекистане за сумы.
              </p>
            </div>

            <div>
              <h3 className="font-semibold mb-4 text-white/90">Страницы</h3>
              <ul className="space-y-2.5">
                <li>
                  <Link href="/ru" className="text-white/60 hover:text-primary text-sm transition-colors">
                    Главная
                  </Link>
                </li>
                <li>
                  <Link href="/ru/1-oylik" className="text-white/60 hover:text-primary text-sm transition-colors">
                    1 месяц Premium
                  </Link>
                </li>
                <li>
                  <Link href="/ru/3-oylik" className="text-white/60 hover:text-primary text-sm transition-colors">
                    3 месяца Premium
                  </Link>
                </li>
                <li>
                  <Link href="/ru/6-oylik" className="text-white/60 hover:text-primary text-sm transition-colors">
                    6 месяцев Premium
                  </Link>
                </li>
                <li>
                  <Link href="/ru/12-oylik" className="text-white/60 hover:text-primary text-sm transition-colors">
                    12 месяцев Premium
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                <li>
                  <Link href="/ru/maqolalar" className="text-white/60 hover:text-primary text-sm transition-colors">
                    Статьи
                  </Link>
                </li>
                <li>
            ...
            <div>
              <h3 className="font-semibold mb-4 text-white/90">Связаться</h3>
              <ul className="space-y-2.5">
                <li>
                  <a
          ...
          <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-white/40 text-sm">
              &copy; {new Date().getFullYear()} Premium Send. Все права защищены.
            </p>
          </div>
        </div>
      </footer>
  ...
  return (
    <footer className="bg-foreground text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li>
                <Link href="/1-oylik" className="text-white/60 hover:text-primary text-sm transition-colors">
                  1 oylik Premium
                </Link>
              </li>
              <li>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            &copy; {new Date().getFullYear()} Premium Send. Barcha huquqlar himoyalangan.
          </p>
        </div>
      </div>
    </footer>
