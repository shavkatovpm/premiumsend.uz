...
export const metadata: Metadata = {
  title: "Купить 100 Telegram Stars — 30 000 сум",
  description:
    "Купить 100 Telegram Stars — 30 000 сум (300 сум/звезда). Для среднего доната и функций ботов. Оплата в сумах через @premiumsendbot, доставка за несколько минут.",
  keywords: [
    "купить 100 stars",
    "100 stars цена",
    "telegram stars 100",
    "сколько стоит 100 stars",
    "100 stars узбекистан",
    "100 stars в сумах",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/ru/100-stars",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "Купить 100 Telegram Stars — 30 000 сум (300 сум/звезда). Для среднего доната и функций ботов. Оплата в сумах через @premiumsendbot, доставка за несколько минут.",
    url: "https://premiumsend.uz/ru/100-stars",
  },
};
...
const useCases = [
  {
    "icon": "📣",
    "title": "Донат каналу/блогеру",
    "desc": "Отправьте заметную поддержку понравившемуся автору"
  },
  {
    "icon": "🎮",
    "title": "Платежи в мини-приложениях",
    "desc": "Внутренние покупки в играх и маркетплейсах Telegram"
  },
  {
    "icon": "🎨",
    "title": "Несколько стикерпаков",
    "desc": "Купите сразу несколько наборов премиум-стикеров или эмодзи"
  },
  {
    "icon": "🤖",
    "title": "Подписка на AI-бота",
    "desc": "Больше запросов и более быстрые ответы в премиум AI-ботах"
  }
];

const whyItems = [
  {
    "title": "Универсальный объём",
    "desc": "Хватает для большинства функций ботов и каналов"
  },
  {
    "title": "Несколько целей сразу",
    "desc": "Донаты, стикеры и мини-приложения — в одном пакете"
  },
  {
    "title": "Прозрачная цена",
    "desc": "300 сум/звезда — та же ставка, что и в пакете 50 Stars"
  }
];

const faqData = [
  {
    "q": "Сколько стоит 100 Stars?",
    "a": "Цена 100 Telegram Stars в Premium Send — 30 000 сум (300 сум/звезда, линейный тариф). Оплата в узбекских сумах — картами UzCard, Humo."
  },
  {
    "q": "Для чего нужны 100 Stars?",
    "a": "Для среднего доната и функций ботов. Отправьте заметную поддержку понравившемуся автору Внутренние покупки в играх и маркетплейсах Telegram"
  },
  {
    "q": "Как купить 100 Stars?",
    "a": "Напишите в Telegram @premiumsendbot, выберите пакет 100 Stars, оплатите в сумах — и через несколько минут Stars будут на вашем аккаунте. Пароль или доступ к аккаунту не требуется."
  },
  {
...
export default function Stars100Page() {
  const productSchema = {
    ...
    "@type": "Product",
    name: "Купить 100 Telegram Stars — 30 000 сум",
    description: "Telegram Stars — 100 штук, купите в Узбекистане в сумах",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "100 Telegram Stars", item: "https://premiumsend.uz/ru/100-stars" },
    ],
  };
    ...
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white/90 text-sm px-4 py-2 rounded-full mb-6">Пакет 100 Stars</div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Купить 100<br />Telegram Stars</h1>
          <p className="text-xl text-white/80 mb-2">Всего <span className="text-white font-bold">30 000 сум</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20">
            <p className="text-sm leading-relaxed text-foreground">
              <strong>Короткий ответ:</strong> Цена 100 Telegram Stars в Premium Send — <strong>30 000 сум</strong> (300 сум/звезда). для среднего доната и функций ботов. Оплатите в сумах через @premiumsendbot — Stars поступят на аккаунт за несколько минут.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-4">Что можно сделать с 100 Stars?</h2>
      ...
      <section className="py-20 bg-section-alt">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">Почему именно 100 Stars?</h2>
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 border border-card-border shadow-sm space-y-4 text-muted leading-relaxed">
            <h2 className="text-2xl font-extrabold text-foreground">100 Telegram Stars — подробная информация</h2>
            <p><strong className="text-foreground">Купить 100 Telegram Stars</strong> — для среднего доната и функций ботов. Через Premium Send вы можете купить Stars в узбекских сумах, картой UzCard или Humo.</p>
            <p>Цена 100 Stars — 30 000 сум (300 сум/звезда). Все пакеты Stars в Premium Send рассчитываются по единому линейному тарифу 300 сум/звезда — цена звезды не меняется независимо от размера пакета. После оплаты Stars поступают на аккаунт в течение нескольких минут.</p>
            <p>Главная причина выбрать 100 Stars: хватает для большинства функций ботов и каналов.</p>
            <p>Нужен другой объём? Посмотрите также пакеты <Link href="/ru/50-stars" className="text-primary font-semibold hover:underline">50 Stars</Link> (15 000 сум), <Link href="/ru/250-stars" className="text-primary font-semibold hover:underline">250 Stars</Link> (75 000 сум), <Link href="/ru/500-stars" className="text-primary font-semibold hover:underline">500 Stars</Link> (150 000 сум) — цена всегда рассчитывается по ставке 300 сум/звезда.</p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">100 Stars — вопросы</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hero-gradient rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl font-extrabold text-white mb-4">100 Telegram Stars — 30 000 сум</h2>
