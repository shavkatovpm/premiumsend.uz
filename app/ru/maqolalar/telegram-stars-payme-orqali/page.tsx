...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "купить stars payme",
    "telegram stars payme приложение",
    "premiumsendbot payme stars",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/ru/maqolalar/telegram-stars-payme-orqali",
    languages: {
...
export default function ArticleStarsPaymeOrqaliRu() {
  const articleSchema = {
    "@context": "https://schema.org",
    "@type": "Article",
    headline: "Купить Telegram Stars через Payme — пошагово",
    description: "Как купить Telegram Stars через приложение Payme в Узбекистане — цены, процесс и безопасность.",
    ...
    mainEntityOfPage: "https://premiumsend.uz/ru/maqolalar/telegram-stars-payme-orqali",
    inLanguage: "ru",
  };
  ...
  const howToSchema = {
    "@context": "https://schema.org",
    "@type": "HowTo",
    name: "Купить Telegram Stars через Payme",
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "Цена Stars через Payme отличается от других способов?",
        acceptedAnswer: {
          "@type": "Answer",
      ...
      {
        "@type": "Question",
        name: "Нужно ли привязывать карту к приложению Payme?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Да, карта Uzcard или Humo должна быть заранее привязана к приложению Payme. Если не привязана, добавить её можно прямо в приложении за пару минут.",
        },
      },
      {
        "@type": "Question",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "Telegram Stars через Payme", item: "https://premiumsend.uz/ru/maqolalar/telegram-stars-payme-orqali" },
    ],
  };
  ...
  return (
    <>
      ...
      <nav className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-muted">
        ...
        <span className="mx-2">/</span>
        <span className="text-foreground font-medium">Telegram Stars через Payme</span>
      </nav>
      ...
      <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 md:py-12">
        <header className="mb-10">
          ...
          <h1 className="text-3xl md:text-4xl font-extrabold text-foreground leading-tight mb-6">
            Купить Telegram Stars через Payme — пошагово
          </h1>
        ...
        <div className="prose prose-lg max-w-none space-y-12">
          <section>
            <h2 className="text-2xl font-extrabold text-foreground mb-4">Почему для Stars через Payme нужен отдельный сервис?</h2>
          ...
          <section>
            <h2 className="text-2xl font-extrabold text-foreground mb-4">Цена Stars через Payme — все пакеты</h2>
            <div className="bg-primary-light/40 border border-primary/20 rounded-xl p-5 mb-6">
              <p className="text-foreground leading-relaxed">
                <strong>Цена:</strong> 300 сум/star — одинаково для Payme, Uzcard, Humo, Click. 50 Stars — <strong>15 000 сум</strong>, 500 Stars — <strong>150 000 сум</strong>, 1000 Stars — <strong>300 000 сум</strong> (самый популярный).
              </p>
            </div>
            <p className="text-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-extrabold text-foreground mb-4">Как купить Stars через Payme? Пошагово</h2>
            ...
            <p className="text-muted leading-relaxed">
              Если карта не привязана к Payme, добавить Uzcard или Humo можно прямо в приложении за пару минут.
            </p>
          </section>
