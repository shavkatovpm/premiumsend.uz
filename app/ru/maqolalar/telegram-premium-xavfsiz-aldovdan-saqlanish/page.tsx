        ...
        <div className="prose prose-lg max-w-none space-y-12">
          ...
          <section>
            ...
            <div className="bg-white rounded-2xl border border-card-border shadow-lg overflow-hidden mb-6">
              ...
              {[
                {
                  n: "1",
                  signal: "Оплата через официальное приложение Click или Payme",
                  check: "Когда бот выдаёт ссылку Click — она должна быть на домене click.uz и автоматически открывать приложение",
                },
                {
                  n: "2",
          ...
          <section>
            ...
            <div className="space-y-4 mb-6">
              {[
                {
                  step: "1",
                  title: "В боте создаётся ссылка Click или Payme",
                  desc: "Бот формирует запрос на оплату 175 000 сум и присылает официальную ссылку click.uz или payme.uz. На этом этапе бот не видит никаких данных карты.",
                },
                {
                  step: "2",
                  title: "Click/Payme запрашивает пароль карты",
                  desc: "Данные карты сохраняются только на сервере Click или Payme. Они зашифрованы по международному стандарту PCI DSS. Бот к этому серверу не имеет доступа.",
                },
                {
                  step: "3",
                  title: "После подтверждения бот получает только факт «оплачено»",
                  desc: "Click/Payme отправляет боту сигнал: «по такому-то номеру чека оплачено 175 000 сум». Внутри сигнала нет ни номера карты, ни кто платил.",
                },
                {
                  step: "4",
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              {[
                {
                  title: "Официальные приложения Click и Payme",
                  desc: "Бот отправляет ссылки на официальные click.uz и payme.uz. Данные карты вообще не попадают на сервер бота.",
                },
                {
