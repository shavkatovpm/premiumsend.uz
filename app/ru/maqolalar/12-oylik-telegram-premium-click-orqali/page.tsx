...
export default function Article12MonthClickRu() {
  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      { "@type": "Question", name: "Что если дневной лимит Click меньше 425 000 сум?", acceptedAnswer: { "@type": "Answer", text: "Лимит P2P-переводов в Click обычно высокий, поэтому 425 000 чаще всего проходит без проблем. Если собственный банковский лимит карты низкий — проверьте карту в Click или временно повысьте лимит интернет-оплат в приложении банка. Если привязана другая карта, можно оплатить с неё." } },
