...
export const metadata: Metadata = {
  title: "Купить 250 Telegram Stars — 75 000 сум",
  description:
    "Купить 250 Telegram Stars — 75 000 сум (300 сум/звезда). Для крупных донатов и закрытого контента. Оплата в сумах через @premiumsendbot, доставка за несколько минут.",
  keywords: [
    "купить 250 stars",
    "250 stars цена",
    "telegram stars 250",
    "сколько стоит 250 stars",
    "250 stars узбекистан",
    "250 stars в сумах",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/ru/250-stars",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "Купить 250 Telegram Stars — 75 000 сум (300 сум/звезда). Для крупных донатов и закрытого контента. Оплата в сумах через @premiumsendbot, доставка за несколько минут.",
    url: "https://premiumsend.uz/ru/250-stars",
  },
};
...
const useCases = [
  {
    "icon": "🔓",
    "title": "Закрытый канал/курс",
    "desc": "Доступ к платным каналам, эксклюзивным видео или закрытым группам"
  },
  {
    "icon": "🎁",
    "title": "Подарок (gift)",
    "desc": "Достаточно для отправки анимированного цифрового подарка другу"
  },
  {
    "icon": "📣",
    "title": "Крупный донат",
    "desc": "Заметная поддержка любимому блогеру или каналу"
  },
  {
    "icon": "🎯",
    "title": "Участие в розыгрышах",
    "desc": "Для розыгрышей призов, которые устраивают каналы"
  }
];

const whyItems = [
  {
    "title": "Хватает на закрытый контент",
    "desc": "Цена большинства платных каналов и курсов в этом диапазоне"
  },
  {
    "title": "Подходит для подарков",
    "desc": "3D-подарки стоят от 25 до 5000 Stars — 250 средний выбор"
  },
  {
    "title": "Один платёж — несколько целей",
    "desc": "Одного заказа хватит сразу на несколько задач"
  }
];

const faqData = [
  {
    "q": "Сколько стоит 250 Stars?",
    "a": "Цена 250 Telegram Stars в Premium Send — 75 000 сум (300 сум/звезда, линейный тариф). Оплата в узбекских сумах — картами UzCard, Humo."
  },
  {
    "q": "Для чего нужны 250 Stars?",
    "a": "Для крупных донатов и закрытого контента. Доступ к платным каналам, эксклюзивным видео или закрытым группам Достаточно для отправки анимированного цифрового подарка другу"
  },
  {
    "q": "Как купить 250 Stars?",
    "a": "Напишите в Telegram @premiumsendbot, выберите пакет 250 Stars, оплатите в сумах — и через несколько минут Stars будут на вашем аккаунте. Пароль или доступ к аккаунту не требуется."
  },
  {
...
export default function Stars250Page() {
  const productSchema = {
    ...
    "@type": "Product",
    name: "Купить 250 Telegram Stars — 75 000 сум",
    description: "Telegram Stars — 250 штук, купите в Узбекистане в сумах",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "250 Telegram Stars", item: "https://premiumsend.uz/ru/250-stars" },
    ],
  };
    ...
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white/90 text-sm px-4 py-2 rounded-full mb-6">Пакет 250 Stars</div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Купить 250<br />Telegram Stars</h1>
          <p className="text-xl text-white/80 mb-2">Всего <span className="text-white font-bold">75 000 сум</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20">
            <p className="text-sm leading-relaxed text-foreground">
              <strong>Короткий ответ:</strong> Цена 250 Telegram Stars в Premium Send — <strong>75 000 сум</strong> (300 сум/звезда). для крупных донатов и закрытого контента. Оплатите в сумах через @premiumsendbot — Stars поступят на аккаунт за несколько минут.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-4">Что можно сделать с 250 Stars?</h2>
      ...
      <section className="py-20 bg-section-alt">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">Почему именно 250 Stars?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 border border-card-border shadow-sm space-y-4 text-muted leading-relaxed">
            <h2 className="text-2xl font-extrabold text-foreground">250 Telegram Stars — подробная информация</h2>
            <p><strong className="text-foreground">Купить 250 Telegram Stars</strong> — для крупных донатов и закрытого контента. Через Premium Send вы можете купить Stars в узбекских сумах, картой UzCard или Humo.</p>
            <p>Цена 250 Stars — 75 000 сум (300 сум/звезда). Все пакеты Stars в Premium Send рассчитываются по единому линейному тарифу 300 сум/звезда — цена звезды не меняется независимо от размера пакета. После оплаты Stars поступают на аккаунт в течение нескольких минут.</p>
            <p>Главная причина выбрать 250 Stars: цена большинства платных каналов и курсов в этом диапазоне.</p>
            <p>Нужен другой объём? Посмотрите также пакеты <Link href="/ru/50-stars" className="text-primary font-semibold hover:underline">50 Stars</Link> (15 000 сум), <Link href="/ru/100-stars" className="text-primary font-semibold hover:underline">100 Stars</Link> (30 000 сум), <Link href="/ru/500-stars" className="text-primary font-semibold hover:underline">500 Stars</Link> (150 000 сум) — цена всегда рассчитывается по ставке 300 сум/звезда.</p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">250 Stars — вопросы</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hero-gradient rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl font-extrabold text-white mb-4">250 Telegram Stars — 75 000 сум</h2>
