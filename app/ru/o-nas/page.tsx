  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "5 способов: Click (по PIN/Face ID за 1-2 минуты), Payme, Uzcard (P2P-перевод), Humo (P2P-перевод) и Visa. Все в сумах — без курсового риска. После подтверждения оплаты Premium активируется за 2-5 минут.",
        },
      },
      {
        "@type": "Question",
            ...
            <div className="space-y-4 mb-6">
              {[
                ...
                },
                {
                  ...
                  desc: "Click, Payme, Uzcard P2P, Humo P2P или Visa. Всё в сумах. Click и Payme — самые быстрые (1-2 минуты).",
                },
                {
                  step: "4",
                  title: "Подтверждение в приложении Click или Payme",
                  desc: "Данные карты сохраняются только на сервере платёжной системы. Бот их не видит. Выдаётся PDF-чек.",
                },
                {
                  step: "5",
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
              {[
                {
                  title: "Click",
                  desc: "В приложении Click по PIN или Face ID за 1-2 минуты. Самый быстрый способ. Если карта сохранена в приложении, номер вводить не нужно.",
                  link: "/ru/maqolalar/telegram-premium-click-orqali",
                  linkText: "Подробнее о Click",
                },
                {
                  title: "Payme",
                  desc: "В приложении Payme как Click — за 1-2 минуты по PIN/Face ID. Приложение открывается, сумма заполнена автоматически.",
                  link: null,
                  linkText: null,
                },
                {
              ...
              {[
                {
                  ...
                  desc: "Бот отправляет ссылки на официальные click.uz и payme.uz. Данные карты — только на сервере платёжной системы.",
                },
                {
