...
export const metadata: Metadata = {
  title: "Купить 50 Telegram Stars — 15 000 сум",
  description:
    "Купить 50 Telegram Stars — 15 000 сум (300 сум/звезда). Самый маленький пакет для пробы. Оплата в сумах через @premiumsendbot, доставка за несколько минут.",
  keywords: [
    "купить 50 stars",
    "50 stars цена",
    "telegram stars 50",
    "сколько стоит 50 stars",
    "50 stars узбекистан",
    "50 stars в сумах",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/ru/50-stars",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "Купить 50 Telegram Stars — 15 000 сум (300 сум/звезда). Самый маленький пакет для пробы. Оплата в сумах через @premiumsendbot, доставка за несколько минут.",
    url: "https://premiumsend.uz/ru/50-stars",
  },
};
...
const useCases = [
  {
    ...
    "desc": "Достаточно для покупки анимированных стикеров или премиум-эмодзи"
  },
  {
    "icon": "💬",
    "title": "Небольшой донат",
    "desc": "Отправьте первую поддержку любимому каналу или блогеру"
  },
  {
    "icon": "🤖",
    "title": "Запросы к AI-ботам",
    "desc": "Для нескольких премиум-запросов в ChatGPT, Claude и похожих ботах"
  },
  {
    "icon": "🧪",
    "title": "Первый опыт",
    "desc": "Самая доступная точка входа, чтобы попробовать, как работают Stars"
  }
];
...
const whyItems = [
  {
    ...
    "desc": "Всего 15 000 сум — идеально, чтобы попробовать Stars впервые"
  },
  {
    "title": "Быстрое решение",
    "desc": "Проверьте, как всё работает, прежде чем покупать больший пакет"
  },
  {
    "title": "Можно докупить",
    "desc": "Если не хватит — Stars легко докупить в любой момент"
  }
];

const faqData = [
  {
    "q": "Сколько стоит 50 Stars?",
    "a": "Цена 50 Telegram Stars в Premium Send — 15 000 сум (300 сум/звезда, линейный тариф). Оплата в узбекских сумах — картами UzCard, Humo."
  },
  {
    "q": "Для чего нужны 50 Stars?",
    "a": "Самый маленький пакет для пробы. Достаточно для покупки анимированных стикеров или премиум-эмодзи Отправьте первую поддержку любимому каналу или блогеру"
  },
  {
    "q": "Как купить 50 Stars?",
    "a": "Напишите в Telegram @premiumsendbot, выберите пакет 50 Stars, оплатите в сумах — и через несколько минут Stars будут на вашем аккаунте. Пароль или доступ к аккаунту не требуется."
  },
  {
...
export default function Stars50Page() {
  const productSchema = {
    ...
    "@type": "Product",
    name: "Купить 50 Telegram Stars — 15 000 сум",
    description: "Telegram Stars — 50 штук, купите в Узбекистане в сумах",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "50 Telegram Stars", item: "https://premiumsend.uz/ru/50-stars" },
    ],
  };
    ...
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white/90 text-sm px-4 py-2 rounded-full mb-6">Пакет 50 Stars</div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">Купить 50<br />Telegram Stars</h1>
          <p className="text-xl text-white/80 mb-2">Всего <span className="text-white font-bold">15 000 сум</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20">
            <p className="text-sm leading-relaxed text-foreground">
              <strong>Короткий ответ:</strong> Цена 50 Telegram Stars в Premium Send — <strong>15 000 сум</strong> (300 сум/звезда). самый маленький пакет для пробы. Оплатите в сумах через @premiumsendbot — Stars поступят на аккаунт за несколько минут.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-4">Что можно сделать с 50 Stars?</h2>
      ...
      <section className="py-20 bg-section-alt">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">Почему именно 50 Stars?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 border border-card-border shadow-sm space-y-4 text-muted leading-relaxed">
            <h2 className="text-2xl font-extrabold text-foreground">50 Telegram Stars — подробная информация</h2>
            <p><strong className="text-foreground">Купить 50 Telegram Stars</strong> — самый маленький пакет для пробы. Через Premium Send вы можете купить Stars в узбекских сумах, картой UzCard или Humo.</p>
            <p>Цена 50 Stars — 15 000 сум (300 сум/звезда). Все пакеты Stars в Premium Send рассчитываются по единому линейному тарифу 300 сум/звезда — цена звезды не меняется независимо от размера пакета. После оплаты Stars поступают на аккаунт в течение нескольких минут.</p>
            <p>Главная причина выбрать 50 Stars: всего 15 000 сум — идеально, чтобы попробовать Stars впервые.</p>
            <p>Нужен другой объём? Посмотрите также пакеты <Link href="/ru/100-stars" className="text-primary font-semibold hover:underline">100 Stars</Link> (30 000 сум), <Link href="/ru/250-stars" className="text-primary font-semibold hover:underline">250 Stars</Link> (75 000 сум), <Link href="/ru/500-stars" className="text-primary font-semibold hover:underline">500 Stars</Link> (150 000 сум) — цена всегда рассчитывается по ставке 300 сум/звезда.</p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">50 Stars — вопросы</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hero-gradient rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl font-extrabold text-white mb-4">50 Telegram Stars — 15 000 сум</h2>
