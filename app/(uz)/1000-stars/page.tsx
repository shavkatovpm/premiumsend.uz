...
export const metadata: Metadata = {
  title: "1000 Telegram Stars sotib olish — 300,000 so'm",
  description:
    "1000 Telegram Stars — 300,000 so'm (300 so'm/star). Eng mashhur paket — Premium sovg'a uchun. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
  keywords: [
    "1000 stars sotib olish",
    "1000 stars narxi",
    "telegram stars 1000",
    "1000 stars qancha turadi",
    "1000 stars uzbekistan",
    "1000 stars so'mda",
    "telegram 1000 stars narxi",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/1000-stars",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "1000 Telegram Stars — 300,000 so'm (300 so'm/star). Eng mashhur paket — Premium sovg'a uchun. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
    url: "https://premiumsend.uz/1000-stars",
  },
};
...
const useCases = [
  {
    ...
    "desc": "Stars orqali 6-12 oylik Premium sovg'a yuborish mexanizmida yetarli rezerv"
  },
  {
    "icon": "📣",
    "title": "Yirik kanal donate'lari",
    "desc": "Katta kanal yoki loyihalar uchun sezilarli qo'llab-quvvatlov"
  },
  {
    "icon": "🏢",
    "title": "Business funksiyalari",
    "desc": "Business akkaunt va kanal boshqaruvidagi bir nechta funksiya uchun"
  },
  {
    "icon": "🎯",
    "title": "Giveaway tashkil qilish",
    "desc": "Kanal obunachilariga g'olib sovg'alari tashkil qilish uchun yetarli zaxira"
  }
];

const whyItems = [
  {
    "title": "Eng ko'p sotib olinadigan paket",
    "desc": "Telegram Premium 6 yoki 12 oylik sovg'a yuborish uchun shu atrofdagi miqdor kerak bo'ladi"
  },
  {
    "title": "Yirik loyihalarga mos",
    "desc": "Katta kanal donate'lari va business funksiyalari uchun qulay zaxira"
  },
  {
    "title": "Yaxshi muvozanat",
    "desc": "Kichik paketlardan farqli — bir necha marta qaytadan buyurtma qilish shart emas"
  }
];

const faqData = [
  {
    "q": "1000 Stars narxi qancha?",
    "a": "1000 Telegram Stars narxi Premium Send da 300,000 so'm (300 so'm/star, linear tarif). To'lov O'zbekiston so'mida — UzCard, Humo kartasi orqali amalga oshiriladi."
  },
  {
    "q": "1000 Stars nima uchun kerak bo'ladi?",
    "a": "Eng mashhur paket — Premium sovg'a uchun. Stars orqali 6-12 oylik Premium sovg'a yuborish mexanizmida yetarli rezerv Katta kanal yoki loyihalar uchun sezilarli qo'llab-quvvatlov"
  },
  {
    "q": "1000 Stars qanday sotib olish mumkin?",
    "a": "Telegram @premiumsendbot ga yozing, 1000 Stars paketini tanlang, so'mda to'lov qiling va bir necha daqiqada Stars akkauntingizga tushadi. Hech qanday parol yoki akkauntga kirish talab qilinmaydi."
  },
  {
...
export default function Stars1000Page() {
  const productSchema = {
    ...
    "@type": "Product",
    name: "1000 Telegram Stars sotib olish — 300,000 so'm",
    description: "Telegram Stars — 1000 dona, O'zbekistonda so'mda sotib oling",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "1000 Telegram Stars", item: "https://premiumsend.uz/1000-stars" },
    ],
  };
    ...
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white/90 text-sm px-4 py-2 rounded-full mb-6">1000 Stars paketi</div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">1000 Telegram Stars<br />sotib olish</h1>
          <p className="text-xl text-white/80 mb-2">Atigi <span className="text-white font-bold">300,000 so&apos;m</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20">
            <p className="text-sm leading-relaxed text-foreground">
              <strong>Qisqacha javob:</strong> 1000 Telegram Stars narxi Premium Send&apos;da <strong>300,000 so&apos;m</strong> (300 so&apos;m/star). Eng mashhur paket — Premium sovg&apos;a uchun. @premiumsendbot orqali so&apos;mda to&apos;lab, bir necha daqiqada akkauntingizga Stars tushadi.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-4">1000 Stars bilan nima qilsa bo&apos;ladi?</h2>
      ...
      <section className="py-20 bg-section-alt">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">Nima uchun aynan 1000 Stars?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 border border-card-border shadow-sm space-y-4 text-muted leading-relaxed">
            <h2 className="text-2xl font-extrabold text-foreground">1000 Telegram Stars — batafsil ma&apos;lumot</h2>
            <p><strong className="text-foreground">1000 Telegram Stars sotib olish</strong> — eng mashhur paket — Premium sovg&apos;a uchun. Premium Send orqali Stars&apos;ni O&apos;zbekiston so&apos;mida, UzCard yoki Humo kartangiz bilan sotib olishingiz mumkin.</p>
            <p>1000 Stars narxi 300,000 so&apos;m (300 so&apos;m/star). Barcha Stars paketlari Premium Send&apos;da bir xil 300 so&apos;m/star linear tarifda hisoblanadi — qaysi paketni tanlasangiz ham bir star bahosi o&apos;zgarmaydi. To&apos;lovdan so&apos;ng Stars bir necha daqiqada akkauntingizga o&apos;tkaziladi.</p>
            <p>1000 Stars tanlashning asosiy sababi: telegram Premium 6 yoki 12 oylik sovg&apos;a yuborish uchun shu atrofdagi miqdor kerak bo&apos;ladi.</p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">1000 Stars — savollar</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hero-gradient rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl font-extrabold text-white mb-4">1000 Telegram Stars — 300,000 so&apos;m</h2>
