...
export const metadata: Metadata = {
  title: "250 Telegram Stars sotib olish — 75,000 so'm",
  description:
    "250 Telegram Stars — 75,000 so'm (300 so'm/star). Yirikroq donate va yopiq kontent uchun. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
  keywords: [
    "250 stars sotib olish",
    "250 stars narxi",
    "telegram stars 250",
    "250 stars qancha turadi",
    "250 stars uzbekistan",
    "250 stars so'mda",
    "telegram 250 stars narxi",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/250-stars",
    languages: {
      uz: "https://premiumsend.uz/250-stars",
      ru: "https://premiumsend.uz/ru/250-stars",
      "x-default": "https://premiumsend.uz/250-stars",
    },
  },
  openGraph: {
    ...ogBaseUz,
    ...
    description:
      "250 Telegram Stars — 75,000 so'm (300 so'm/star). Yirikroq donate va yopiq kontent uchun. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
    url: "https://premiumsend.uz/250-stars",
  },
};
...
const useCases = [
  {
    "icon": "🔓",
    "title": "Yopiq kanal/kurs",
    "desc": "Pullik kanallar, maxsus videolar yoki yopiq guruhlarga kirish huquqi"
  },
  {
    "icon": "🎁",
    "title": "Sovg'a (gift)",
    "desc": "Do'stingizga animatsiyali raqamli sovg'a yuborish uchun yetarli"
  },
  {
    "icon": "📣",
    "title": "Katta donate",
    "desc": "Sevimli bloger yoki kanalga sezilarli qo'llab-quvvatlov"
  },
  {
    "icon": "🎯",
    "title": "Giveaway ishtiroki",
    "desc": "Kanallar tashkil qiladigan g'olib sovg'alarida qatnashish uchun"
  }
];

const whyItems = [
  {
    "title": "Yopiq kontentga yetadi",
    "desc": "Ko'pchilik pullik kanal va kurslarning narxi shu oraliqda"
  },
  {
    "title": "Sovg'a uchun mos",
    "desc": "3D animatsiyali gift'lar 25 dan 5000 Stars'gacha bo'ladi — 250 o'rtacha tanlov"
  },
  {
    "title": "Hali ham bitta to'lov",
    "desc": "Bitta buyurtma bilan bir nechta maqsadga yetarli zaxira"
  }
];

const faqData = [
  {
    "q": "250 Stars narxi qancha?",
    "a": "250 Telegram Stars narxi Premium Send da 75,000 so'm (300 so'm/star, linear tarif). To'lov O'zbekiston so'mida — UzCard, Humo kartasi orqali amalga oshiriladi."
  },
  {
    "q": "250 Stars nima uchun kerak bo'ladi?",
    "a": "Yirikroq donate va yopiq kontent uchun. Pullik kanallar, maxsus videolar yoki yopiq guruhlarga kirish huquqi Do'stingizga animatsiyali raqamli sovg'a yuborish uchun yetarli"
  },
  {
    "q": "250 Stars qanday sotib olish mumkin?",
    "a": "Telegram @premiumsendbot ga yozing, 250 Stars paketini tanlang, so'mda to'lov qiling va bir necha daqiqada Stars akkauntingizga tushadi. Hech qanday parol yoki akkauntga kirish talab qilinmaydi."
  },
  {
...
export default function Stars250Page() {
  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    name: "250 Telegram Stars sotib olish — 75,000 so'm",
    description: "Telegram Stars — 250 dona, O'zbekistonda so'mda sotib oling",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "250 Telegram Stars", item: "https://premiumsend.uz/250-stars" },
    ],
  };
  ...
  return (
    <>
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-muted">
        ...
        <span className="mx-2">/</span>
        <span className="text-foreground font-medium">250 Telegram Stars</span>
      </nav>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white/90 text-sm px-4 py-2 rounded-full mb-6">250 Stars paketi</div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">250 Telegram Stars<br />sotib olish</h1>
          <p className="text-xl text-white/80 mb-2">Atigi <span className="text-white font-bold">75,000 so&apos;m</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20">
            <p className="text-sm leading-relaxed text-foreground">
              <strong>Qisqacha javob:</strong> 250 Telegram Stars narxi Premium Send&apos;da <strong>75,000 so&apos;m</strong> (300 so&apos;m/star). Yirikroq donate va yopiq kontent uchun. @premiumsendbot orqali so&apos;mda to&apos;lab, bir necha daqiqada akkauntingizga Stars tushadi.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-4">250 Stars bilan nima qilsa bo&apos;ladi?</h2>
      ...
      <section className="py-20 bg-section-alt">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">Nima uchun aynan 250 Stars?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 border border-card-border shadow-sm space-y-4 text-muted leading-relaxed">
            <h2 className="text-2xl font-extrabold text-foreground">250 Telegram Stars — batafsil ma&apos;lumot</h2>
            <p><strong className="text-foreground">250 Telegram Stars sotib olish</strong> — yirikroq donate va yopiq kontent uchun. Premium Send orqali Stars&apos;ni O&apos;zbekiston so&apos;mida, UzCard yoki Humo kartangiz bilan sotib olishingiz mumkin.</p>
            <p>250 Stars narxi 75,000 so&apos;m (300 so&apos;m/star). Barcha Stars paketlari Premium Send&apos;da bir xil 300 so&apos;m/star linear tarifda hisoblanadi — qaysi paketni tanlasangiz ham bir star bahosi o&apos;zgarmaydi. To&apos;lovdan so&apos;ng Stars bir necha daqiqada akkauntingizga o&apos;tkaziladi.</p>
            <p>250 Stars tanlashning asosiy sababi: ko&apos;pchilik pullik kanal va kurslarning narxi shu oraliqda.</p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">250 Stars — savollar</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hero-gradient rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl font-extrabold text-white mb-4">250 Telegram Stars — 75,000 so&apos;m</h2>
