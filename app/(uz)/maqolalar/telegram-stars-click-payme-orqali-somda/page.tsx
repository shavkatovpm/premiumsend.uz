        ...
        <header className="mb-10">
          ...
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20 mb-6">
            <p className="text-foreground leading-relaxed font-medium">
              ...
              <Link href="https://telegram.me/starsjoybot" target="_blank" className="text-primary hover:underline">@starsjoybot</Link>{" "}
        ...
        <div className="prose prose-lg max-w-none space-y-12">
          ...
          <section>
            <div className="hero-gradient rounded-2xl p-6 md:p-8 text-center">
              ...
              <Link href="https://telegram.me/starsjoybot" target="_blank" className="inline-flex items-center gap-2 px-6 py-3 bg-white text-primary font-bold rounded-xl hover:shadow-2xl transition-all">
          ...
          <section>
            <div className="hero-gradient rounded-2xl p-8 md:p-10 text-center relative overflow-hidden">
              ...
              <div className="relative">
                ...
                <Link href="https://telegram.me/starsjoybot" target="_blank" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-primary font-bold rounded-2xl hover:shadow-2xl transition-all text-lg">
