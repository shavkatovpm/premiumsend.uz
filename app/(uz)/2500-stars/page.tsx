...
export const metadata: Metadata = {
  title: "2500 Telegram Stars sotib olish — 750,000 so'm",
  description:
    "2500 Telegram Stars — 750,000 so'm (300 so'm/star). Bir nechta Premium sovg'a va business uchun. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
  keywords: [
    "2500 stars sotib olish",
    "2500 stars narxi",
    "telegram stars 2500",
    "2500 stars qancha turadi",
    "2500 stars uzbekistan",
    "2500 stars so'mda",
    "telegram 2500 stars narxi",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/2500-stars",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "2500 Telegram Stars — 750,000 so'm (300 so'm/star). Bir nechta Premium sovg'a va business uchun. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
    url: "https://premiumsend.uz/2500-stars",
  },
};
...
const useCases = [
  {
    "icon": "🎁",
    "title": "Bir nechta Premium sovg'a",
    "desc": "Bir nechta odamga Telegram Premium sovg'a qilish uchun yetarli zaxira"
  },
  {
    "icon": "🏢",
    "title": "Business kanal",
    "desc": "Yirik kanal kompaniyalari va business funksiyalari uchun mos"
  },
  {
    "icon": "📣",
    "title": "Katta miqyosdagi donate",
    "desc": "Yirik loyihalarni uzoq muddat qo'llab-quvvatlash"
  },
  {
    "icon": "🎯",
    "title": "Ko'plab giveaway",
    "desc": "Bir nechta g'olib sovg'asi tashkil qilish uchun yetarli hajm"
  }
];

const whyItems = [
  {
    "title": "Ko'p maqsadli zaxira",
    "desc": "Bir nechta Premium sovg'a yoki business ehtiyoji uchun bitta buyurtma yetadi"
  },
  {
    "title": "Uzoq muddatga yetadi",
    "desc": "Tez-tez qayta buyurtma qilishdan qutuladi"
  },
  {
    "title": "Bir xil shaffof narx",
    "desc": "300 so'm/star — kichik paketlar bilan bir xil stavka, chegirma yo'q ammo jarima ham yo'q"
  }
];

const faqData = [
  {
    "q": "2500 Stars narxi qancha?",
    "a": "2500 Telegram Stars narxi Premium Send da 750,000 so'm (300 so'm/star, linear tarif). To'lov O'zbekiston so'mida — UzCard, Humo kartasi orqali amalga oshiriladi."
  },
  {
    "q": "2500 Stars nima uchun kerak bo'ladi?",
    "a": "Bir nechta Premium sovg'a va business uchun. Bir nechta odamga Telegram Premium sovg'a qilish uchun yetarli zaxira Yirik kanal kompaniyalari va business funksiyalari uchun mos"
  },
  {
    "q": "2500 Stars qanday sotib olish mumkin?",
    "a": "Telegram @premiumsendbot ga yozing, 2500 Stars paketini tanlang, so'mda to'lov qiling va bir necha daqiqada Stars akkauntingizga tushadi. Hech qanday parol yoki akkauntga kirish talab qilinmaydi."
  },
  {
...
export default function Stars2500Page() {
  const productSchema = {
    ...
    "@type": "Product",
    name: "2500 Telegram Stars sotib olish — 750,000 so'm",
    description: "Telegram Stars — 2500 dona, O'zbekistonda so'mda sotib oling",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "2500 Telegram Stars", item: "https://premiumsend.uz/2500-stars" },
    ],
  };
    ...
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white/90 text-sm px-4 py-2 rounded-full mb-6">2500 Stars paketi</div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">2500 Telegram Stars<br />sotib olish</h1>
          <p className="text-xl text-white/80 mb-2">Atigi <span className="text-white font-bold">750,000 so&apos;m</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20">
            <p className="text-sm leading-relaxed text-foreground">
              <strong>Qisqacha javob:</strong> 2500 Telegram Stars narxi Premium Send&apos;da <strong>750,000 so&apos;m</strong> (300 so&apos;m/star). Bir nechta Premium sovg&apos;a va business uchun. @premiumsendbot orqali so&apos;mda to&apos;lab, bir necha daqiqada akkauntingizga Stars tushadi.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-4">2500 Stars bilan nima qilsa bo&apos;ladi?</h2>
      ...
      <section className="py-20 bg-section-alt">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">Nima uchun aynan 2500 Stars?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 border border-card-border shadow-sm space-y-4 text-muted leading-relaxed">
            <h2 className="text-2xl font-extrabold text-foreground">2500 Telegram Stars — batafsil ma&apos;lumot</h2>
            <p><strong className="text-foreground">2500 Telegram Stars sotib olish</strong> — bir nechta Premium sovg&apos;a va business uchun. Premium Send orqali Stars&apos;ni O&apos;zbekiston so&apos;mida, UzCard yoki Humo kartangiz bilan sotib olishingiz mumkin.</p>
            <p>2500 Stars narxi 750,000 so&apos;m (300 so&apos;m/star). Barcha Stars paketlari Premium Send&apos;da bir xil 300 so&apos;m/star linear tarifda hisoblanadi — qaysi paketni tanlasangiz ham bir star bahosi o&apos;zgarmaydi. To&apos;lovdan so&apos;ng Stars bir necha daqiqada akkauntingizga o&apos;tkaziladi.</p>
            <p>2500 Stars tanlashning asosiy sababi: bir nechta Premium sovg&apos;a yoki business ehtiyoji uchun bitta buyurtma yetadi.</p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">2500 Stars — savollar</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hero-gradient rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl font-extrabold text-white mb-4">2500 Telegram Stars — 750,000 so&apos;m</h2>
