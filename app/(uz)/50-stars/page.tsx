...
export const metadata: Metadata = {
  title: "50 Telegram Stars sotib olish — 15,000 so'm",
  description:
    "50 Telegram Stars — 15,000 so'm (300 so'm/star). Sinab ko'rish uchun eng kichik paket. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
  keywords: [
    "50 stars sotib olish",
    "50 stars narxi",
    "telegram stars 50",
    "50 stars qancha turadi",
    "50 stars uzbekistan",
    "50 stars so'mda",
    "telegram 50 stars narxi",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/50-stars",
    languages: {
      uz: "https://premiumsend.uz/50-stars",
      ru: "https://premiumsend.uz/ru/50-stars",
      "x-default": "https://premiumsend.uz/50-stars",
    },
  },
  openGraph: {
    ...ogBaseUz,
    ...
    description:
      "50 Telegram Stars — 15,000 so'm (300 so'm/star). Sinab ko'rish uchun eng kichik paket. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
    url: "https://premiumsend.uz/50-stars",
  },
};
...
const useCases = [
  {
    "icon": "🎨",
    "title": "Stiker va emoji",
    "desc": "Animatsiyali stiker paketlari yoki premium emojilarni sotib olish uchun yetarli"
  },
  {
    "icon": "💬",
    "title": "Kichik donate",
    "desc": "Yoqqan kanal yoki blogerga birinchi qo'llab-quvvatlov Stars'ini yuborish"
  },
  {
    "icon": "🤖",
    "title": "AI bot so'rovlari",
    "desc": "ChatGPT, Claude kabi botlarda bir nechta premium so'rov uchun"
  },
  {
    "icon": "🧪",
    "title": "Birinchi tajriba",
    "desc": "Stars nima ekanini sinab ko'rish uchun eng arzon boshlanish nuqtasi"
  }
];

const whyItems = [
  {
    "title": "Kam xarajat bilan boshlash",
    "desc": "Atigi 15,000 so'm — Stars'ni birinchi marta sinab ko'rish uchun ideal"
  },
  {
    "title": "Tez qaror",
    "desc": "Katta miqdorga qaror qilishdan oldin tizim qanday ishlashini ko'rasiz"
  },
  {
    "title": "Istalgan vaqt kengaytirish",
    "desc": "Yetmasa, keyinroq yana Stars qo'shib olishingiz mumkin"
  }
];

const faqData = [
  {
    "q": "50 Stars narxi qancha?",
    "a": "50 Telegram Stars narxi Premium Send da 15,000 so'm (300 so'm/star, linear tarif). To'lov O'zbekiston so'mida — UzCard, Humo kartasi orqali amalga oshiriladi."
  },
  {
    "q": "50 Stars nima uchun kerak bo'ladi?",
    "a": "Sinab ko'rish uchun eng kichik paket. Animatsiyali stiker paketlari yoki premium emojilarni sotib olish uchun yetarli Yoqqan kanal yoki blogerga birinchi qo'llab-quvvatlov Stars'ini yuborish"
  },
  {
    "q": "50 Stars qanday sotib olish mumkin?",
    "a": "Telegram @premiumsendbot ga yozing, 50 Stars paketini tanlang, so'mda to'lov qiling va bir necha daqiqada Stars akkauntingizga tushadi. Hech qanday parol yoki akkauntga kirish talab qilinmaydi."
  },
  {
...
export default function Stars50Page() {
  const productSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    name: "50 Telegram Stars sotib olish — 15,000 so'm",
    description: "Telegram Stars — 50 dona, O'zbekistonda so'mda sotib oling",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "50 Telegram Stars", item: "https://premiumsend.uz/50-stars" },
    ],
  };
  ...
  return (
    <>
      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 text-sm text-muted">
        ...
        <span className="mx-2">/</span>
        <span className="text-foreground font-medium">50 Telegram Stars</span>
      </nav>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white/90 text-sm px-4 py-2 rounded-full mb-6">50 Stars paketi</div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">50 Telegram Stars<br />sotib olish</h1>
          <p className="text-xl text-white/80 mb-2">Atigi <span className="text-white font-bold">15,000 so&apos;m</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20">
            <p className="text-sm leading-relaxed text-foreground">
              <strong>Qisqacha javob:</strong> 50 Telegram Stars narxi Premium Send&apos;da <strong>15,000 so&apos;m</strong> (300 so&apos;m/star). Sinab ko&apos;rish uchun eng kichik paket. @premiumsendbot orqali so&apos;mda to&apos;lab, bir necha daqiqada akkauntingizga Stars tushadi.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-4">50 Stars bilan nima qilsa bo&apos;ladi?</h2>
      ...
      <section className="py-20 bg-section-alt">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">Nima uchun aynan 50 Stars?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 border border-card-border shadow-sm space-y-4 text-muted leading-relaxed">
            <h2 className="text-2xl font-extrabold text-foreground">50 Telegram Stars — batafsil ma&apos;lumot</h2>
            <p><strong className="text-foreground">50 Telegram Stars sotib olish</strong> — sinab ko&apos;rish uchun eng kichik paket. Premium Send orqali Stars&apos;ni O&apos;zbekiston so&apos;mida, UzCard yoki Humo kartangiz bilan sotib olishingiz mumkin.</p>
            <p>50 Stars narxi 15,000 so&apos;m (300 so&apos;m/star). Barcha Stars paketlari Premium Send&apos;da bir xil 300 so&apos;m/star linear tarifda hisoblanadi — qaysi paketni tanlasangiz ham bir star bahosi o&apos;zgarmaydi. To&apos;lovdan so&apos;ng Stars bir necha daqiqada akkauntingizga o&apos;tkaziladi.</p>
            <p>50 Stars tanlashning asosiy sababi: atigi 15,000 so&apos;m — Stars&apos;ni birinchi marta sinab ko&apos;rish uchun ideal.</p>
            <p>Boshqa miqdorlar kerakmi? <Link href="/100-stars" className="text-primary font-semibold hover:underline">100 Stars</Link> (30,000 so&apos;m), <Link href="/250-stars" className="text-primary font-semibold hover:underline">250 Stars</Link> (75,000 so&apos;m), <Link href="/500-stars" className="text-primary font-semibold hover:underline">500 Stars</Link> (150,000 so&apos;m) paketlarini ham ko&apos;rib chiqing — narx har doim 300 so&apos;m/star stavkasida hisoblanadi.</p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">50 Stars — savollar</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hero-gradient rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl font-extrabold text-white mb-4">50 Telegram Stars — 15,000 so&apos;m</h2>
