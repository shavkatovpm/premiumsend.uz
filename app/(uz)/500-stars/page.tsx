...
export const metadata: Metadata = {
  title: "500 Telegram Stars sotib olish — 150,000 so'm",
  description:
    "500 Telegram Stars — 150,000 so'm (300 so'm/star). Premium sovg'a va yirik donate uchun zaxira. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
  keywords: [
    "500 stars sotib olish",
    "500 stars narxi",
    "telegram stars 500",
    "500 stars qancha turadi",
    "500 stars uzbekistan",
    "500 stars so'mda",
    "telegram 500 stars narxi",
  ],
  alternates: {
    canonical: "https://premiumsend.uz/500-stars",
    languages: {
  ...
  openGraph: {
    ...
    description:
      "500 Telegram Stars — 150,000 so'm (300 so'm/star). Premium sovg'a va yirik donate uchun zaxira. @premiumsendbot orqali so'mda to'lab, bir necha daqiqada oling.",
    url: "https://premiumsend.uz/500-stars",
  },
};
...
const useCases = [
  {
    ...
    "desc": "Stars orqali Premium gift yuborishda taxminan shu miqdor (3 oylikka yaqin) zaxira sifatida yetarli"
  },
  {
    "icon": "📣",
    "title": "Yirik donate",
    "desc": "Kanal yoki bloger uchun sezilarli hajmdagi qo'llab-quvvatlov"
  },
  {
    "icon": "🎨",
    "title": "Bir nechta gift",
    "desc": "Bir nechta animatsiyali sovg'ani birga yuborish imkoniyati"
  },
  {
    "icon": "🏢",
    "title": "Business kanal",
    "desc": "Kanal boshqaruvida bir nechta funksiya uchun zaxira"
  }
];

const whyItems = [
  {
    "title": "Gift uchun mo'ljallangan zaxira",
    "desc": "Premium sovg'a qilish mexanizmida odatda shu atrofda Stars talab qilinadi"
  },
  {
    "title": "Yirik donate uchun yetarli",
    "desc": "Katta kanal yoki loyihani qo'llab-quvvatlash uchun mos hajm"
  },
  {
    "title": "Bitta buyurtma, bir nechta ishlatish",
    "desc": "Zaxira sifatida saqlab, keyin turli maqsadlarga sarflash mumkin"
  }
];

const faqData = [
  {
    "q": "500 Stars narxi qancha?",
    "a": "500 Telegram Stars narxi Premium Send da 150,000 so'm (300 so'm/star, linear tarif). To'lov O'zbekiston so'mida — UzCard, Humo kartasi orqali amalga oshiriladi."
  },
  {
    "q": "500 Stars nima uchun kerak bo'ladi?",
    "a": "Premium sovg'a va yirik donate uchun zaxira. Stars orqali Premium gift yuborishda taxminan shu miqdor (3 oylikka yaqin) zaxira sifatida yetarli Kanal yoki bloger uchun sezilarli hajmdagi qo'llab-quvvatlov"
  },
  {
    "q": "500 Stars qanday sotib olish mumkin?",
    "a": "Telegram @premiumsendbot ga yozing, 500 Stars paketini tanlang, so'mda to'lov qiling va bir necha daqiqada Stars akkauntingizga tushadi. Hech qanday parol yoki akkauntga kirish talab qilinmaydi."
  },
  {
...
export default function Stars500Page() {
  const productSchema = {
    ...
    "@type": "Product",
    name: "500 Telegram Stars sotib olish — 150,000 so'm",
    description: "Telegram Stars — 500 dona, O'zbekistonda so'mda sotib oling",
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { "@type": "ListItem", position: 3, name: "500 Telegram Stars", item: "https://premiumsend.uz/500-stars" },
    ],
  };
    ...
    <>
      ...
      <section className="hero-gradient relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 relative text-center">
          <div className="inline-flex items-center gap-2 bg-white/15 backdrop-blur-sm text-white/90 text-sm px-4 py-2 rounded-full mb-6">500 Stars paketi</div>
          <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">500 Telegram Stars<br />sotib olish</h1>
          <p className="text-xl text-white/80 mb-2">Atigi <span className="text-white font-bold">150,000 so&apos;m</span></p>
        ...
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-primary-light/40 rounded-xl p-5 border border-primary/20">
            <p className="text-sm leading-relaxed text-foreground">
              <strong>Qisqacha javob:</strong> 500 Telegram Stars narxi Premium Send&apos;da <strong>150,000 so&apos;m</strong> (300 so&apos;m/star). Premium sovg&apos;a va yirik donate uchun zaxira. @premiumsendbot orqali so&apos;mda to&apos;lab, bir necha daqiqada akkauntingizga Stars tushadi.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-4">500 Stars bilan nima qilsa bo&apos;ladi?</h2>
      ...
      <section className="py-20 bg-section-alt">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">Nima uchun aynan 500 Stars?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-2xl p-8 border border-card-border shadow-sm space-y-4 text-muted leading-relaxed">
            <h2 className="text-2xl font-extrabold text-foreground">500 Telegram Stars — batafsil ma&apos;lumot</h2>
            <p><strong className="text-foreground">500 Telegram Stars sotib olish</strong> — premium sovg&apos;a va yirik donate uchun zaxira. Premium Send orqali Stars&apos;ni O&apos;zbekiston so&apos;mida, UzCard yoki Humo kartangiz bilan sotib olishingiz mumkin.</p>
            <p>500 Stars narxi 150,000 so&apos;m (300 so&apos;m/star). Barcha Stars paketlari Premium Send&apos;da bir xil 300 so&apos;m/star linear tarifda hisoblanadi — qaysi paketni tanlasangiz ham bir star bahosi o&apos;zgarmaydi. To&apos;lovdan so&apos;ng Stars bir necha daqiqada akkauntingizga o&apos;tkaziladi.</p>
            <p>500 Stars tanlashning asosiy sababi: premium sovg&apos;a qilish mexanizmida odatda shu atrofda Stars talab qilinadi.</p>
      ...
      <section className="py-20">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-foreground text-center mb-12">500 Stars — savollar</h2>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="hero-gradient rounded-3xl p-10 md:p-14 text-center relative overflow-hidden">
            ...
            <div className="relative">
              <h2 className="text-3xl font-extrabold text-white mb-4">500 Telegram Stars — 150,000 so&apos;m</h2>
